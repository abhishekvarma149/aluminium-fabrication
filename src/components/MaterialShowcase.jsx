...
const MATERIALS = {
  upvc: {
    ...
    products: [
      ...
      { id: 'u2', name: 'uPVC Sliding Window', image: '/windows/upvc_sliding.png', link: '#' },
      { id: 'u3', name: 'uPVC Casement Window', image: '/windows/upvc_casement.png', link: '#' },
      { id: 'u4', name: 'uPVC Tilt & Turn Window', image: '/windows/upvc_tilt_turn.png', link: '#' },
      { id: 'u5', name: 'uPVC French Window', image: '/windows/upvc_french.png', link: '#' },
      { id: 'u6', name: 'uPVC Bay Window', image: '/windows/upvc_bay.png', link: '#' },
      { id: 'u7', name: 'uPVC Corner Window', image: '/windows/upvc_corner.png', link: '#' },
      { id: 'u8', name: 'uPVC Picture Window', image: '/windows/upvc_picture.png', link: '#' },
      { id: 'u9', name: 'uPVC Awning Window', image: '/windows/upvc_awning.png', link: '#' },
      { id: 'u10', name: 'uPVC Bi-Fold Window', image: '/windows/upvc_bifold.png', link: '#' },
      { id: 'u11', name: 'uPVC Lift & Slide Window', image: '/windows/upvc_lift_slide.png', link: '#' },
